...
merge.all <- read.table("/data/tusers/boxu/lrft/result/nanopore/human/figure/q0/all.intersect.txt")
...
venn.plot <- venn.diagram(venn_data,
  filename = "/data/tusers/boxu/lrft/result/nanopore/human/figure/q0/merge.all.png",##韦恩图的名字
  lty = 1,
  lwd = 0,
  col = "black",  ##圈的颜色
