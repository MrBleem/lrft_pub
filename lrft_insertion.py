...
READS = bamfile.fetch( "1", 834425, 834737 )
outFile = RESULT_PATH + PREFIX + ".lrft.table.temp.txt"
...
def get_insertion_position_germline(genome_map_position_start, cigar, clip_left_len):
	...
	if abs( pre_insertion_cigar_l - (clip_left_len - s_cigar_S ) ) > 1000:
		print('test')
